...
High Predictive Power: The final model achieved an $\text{R}^{2}$ score of approximately 0.82 on the test data, indicating that the selected features explain about 82% of the variance in the bike rental demand.
